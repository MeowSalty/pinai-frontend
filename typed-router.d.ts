...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/provider/': RouteRecordInfo<
      ...
      | never
    >,
    '/provider/[id].edit': RouteRecordInfo<
      '/provider/[id].edit',
      '/provider/:id/edit',
      { id: ParamValue<true> },
      { id: ParamValue<false> },
    ...
    '/provider/add': RouteRecordInfo<
      ...
      | never
    >,
    '/provider/batch-import': RouteRecordInfo<
      '/provider/batch-import',
      '/provider/batch-import',
      Record<never, never>,
      Record<never, never>,
      | never
    >,
    '/provider/batch-update': RouteRecordInfo<
      '/provider/batch-update',
      '/provider/batch-update',
      Record<never, never>,
      Record<never, never>,
